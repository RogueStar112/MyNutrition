    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-3 grid-rows-3 gap-3">
                ...
                <x-dashboard-link colspan="1" heading="Meal" icon="fas fa-utensils fa-3x text-lime-300">
                ...
                <x-dashboard-link colspan="1" heading="Water" icon="fas fa-tint fa-3x text-blue-300">
                    {{ __('12 glasses') }}
                </x-dashboard-link>
