<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold italic uppercase dark:text-white text-black dark:text-white text-3xl text-gray-800 leading-tight">
            {{ __('Main Menu') }}
        </h2>
    </x-slot>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-flow-row-dense grid-cols-1 md:grid-cols-3 md:grid-rows-1 gap-3 [&>*]:mx-2 md:[&>*]:mx-0">
                ...
                {{-- <h2 class="text-6xl italic font-extrabold text-black dark:text-white col-span-3 md:col-span-6 m-4 pb-6 border-b-4 border-gray-500">Main Menu</h2> --}}

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2  duration-300 hover:bg-red-800 dark:hover:bg-red-800 [&>*]:hover:text-black [&>*]:hover:border-b-black" href="{{route('food.create')}}">
                        ...
                        <p class="text-black dark:text-white p-4">Create new Food Items.</p>
                    </a>

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2  duration-300 hover:bg-orange-800  dark:hover:bg-orange-800 [&>*]:hover:text-black [&>*]:hover:border-b-black" href="{{route('meal.create')}}">
                        ...
                        <p class="text-black dark:text-white p-4">Create new Meals with existing Food.</p>
                    </a>

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2  duration-300 hover:bg-yellow-800  dark:hover:bg-yellow-800 [&>*]:hover:text-black [&>*]:hover:border-b-black" href="{{route('exercise.form')}}">
                        ...
                        <p class="text-black dark:text-white p-4">Log your Exercises.</p>
                    </a>   

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2  duration-300 hover:bg-cyan-800  dark:hover:bg-cyan-800 [&>*]:hover:text-black [&>*]:hover:border-b-black" href="{{route('body_stats.form')}}">
                        ...
                        <p class="text-black dark:text-white p-4">Weight, Height & Body Fat.</p>
                    </a>

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2 hover:bg-blue-800 dark:hover:bg-blue-800 [&>*]:hover:text-black [&>*]:hover:border-b-black duration-300" href="{{route('water.form')}}">
                        ...
                        <p class="text-black dark:text-white p-4">Log your Water Intake.</p>
                    </a>

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2 hover:bg-indigo-800 dark:hover:bg-indigo-800 [&>*]:hover:text-black [&>*]:hover:border-b-black duration-300" href="{{route('sleep.form')}}">
                        ...
                        <p class="text-black dark:text-white p-4">Log your Sleep. (WIP)</p>
                    </a>
{{-- 
                <h2 class="text-6xl italic font-extrabold text-black dark:text-white m-4 pb-6 border-b-4 border-gray-500 w-full col-span-6">ACHIEVE</h2> --}}

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2 hover:bg-blue-600 dark:hover:bg-blue-600 [&>*]:hover:text-black [&>*]:hover:border-b-black duration-300" href="{{route('goals.form')}}">

                        <div class="flex justify-between text-blue-800 dark:text-blue-300 border-b-4 dark:border-b-blue-300 border-b-blue-800 items-center">
                            <h2 class="text-4xl uppercase p-4 font-black">Goals</h2>
                            <i class="fas fa-bullseye fa-3x p-4"></i>
                        </div>

                        <p class="text-black dark:text-white p-4">Set Macro and Sleep Goals. (Beta)</p>
                    </a>
                    ...
                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-2 hover:bg-orange-800  dark:hover:bg-orange-800 [&>*]:hover:text-black [&>*]:hover:border-b-black duration-300" href="{{route('visualizer.show')}}">
                        ...
                        <div class="flex justify-between text-orange-800 dark:text-orange-300 border-b-4 border-b-orange-800 dark:border-b-orange-300 items-center">
                    ...
                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-3  relative">
                        ...
                        <p class="-rotate-12 text-4xl absolute left-1/2 top-1/4 text-black dark:text-white opacity-100 font-black -translate-x-1/2 translate-y-1/2 w-full text-center z-40">Coming Eventually</p>

                        <div class="flex justify-between text-yellow-500 dark:text-yellow-200 border-b-4 border-b-yellow-500 dark:border-b-yellow-200 opacity-80 blur-sm select-none items-center">
                            <h2 class="text-4xl uppercase p-4 font-black">Trophies</h2>
                            <i class="fas fa-trophy fa-3x p-4"></i>
                        </div>

                        <p class="text-black dark:text-white p-4 opacity-80 blur-sm select-none">See what achievements you can get.</p>
                    </a>

                {{-- <h2 class="text-6xl italic font-extrabold text-black dark:text-white m-4 pb-6 border-b-4 border-gray-500 w-full col-span-6">STATISTICS</h2> --}}

                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-3 relative">

                        <p class="-rotate-12 text-4xl absolute left-1/2 top-1/4 text-black dark:text-white opacity-100 font-black -translate-x-1/2 translate-y-1/2  text-center w-full z-50">Coming Someday</p>
                        ...
                        <p class="text-black dark:text-white p-4 blur-sm">See how each day goes! (Beta)</p>
                    </a>

                    {{-- <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 md:col-span-3 hover:bg-orange-800 [&>*]:hover:text-black [&>*]:hover:border-b-black duration-300" href="{{route('visualizer.show')}}">
                    ...
                    <a class="text-2xl italic bg-slate-200 dark:bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 /md:col-span-6 relative overflow-hidden">

                        <p class="-rotate-12 text-4xl absolute left-1/2 top-1/4 text-black dark:text-white opacity-100 font-black -translate-x-1/2 translate-y-1/2  text-center w-full">Coming Soon</p>
                        ...
                        <p class="text-black dark:text-white p-4 opacity-80 blur-sm select-none">See how each day goes! (Beta)</p>
                    </a>
                ...
                {{-- <div class="bg-white dark:bg-slate-200 dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg col-span-3">
