...
{{-- 
                ...
                {{-- <h2 class="text-6xl italic font-extrabold text-white m-4 pb-6 border-b-4 border-gray-500 w-full col-span-6">STATISTICS</h2> --}}
                    ...
                    {{-- <a class="text-2xl italic bg-slate-800 p-4 rounded-lg shadow-2xl col-span-1 md:col-span-3 hover:bg-orange-800 [&>*]:hover:text-black [&>*]:hover:border-b-black duration-300" href="{{route('visualizer.show')}}">
