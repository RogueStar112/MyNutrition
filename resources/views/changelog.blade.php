<x-app-layout>
  ...
  <div class="w-screen h-full max-w-7xl mx-auto text-black dark:text-white mt-8 pt-6 px-4 sm:px-6 lg:px-8 flex flex-col gap-4">
    ...
    <div class=" bg-slate-200 dark:bg-slate-800 p-4 rounded-lg">
      ...
      <p class="text-gray-800 dark:text-gray-400">08/03/2025 - 17/03/2025</p>
    ...
    <div class=" bg-slate-200 dark:bg-slate-800 p-4 rounded-lg">
      ...
      <p class="text-gray-800 dark:text-gray-400">01/03/2025 - 07/03/2025</p>
    ...
    <div class=" bg-slate-200 dark:bg-slate-800 p-4 rounded-lg">
      ...
      <p class="text-gray-800 dark:text-gray-400">17/02/2025 - 01/03/2025</p>
