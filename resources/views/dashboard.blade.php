        ...
        <div class="grid grid-cols-5 grid-rows-5 w-full h-full gap-2 /h-[calc(100vh-8rem)] max-h-[900px] [&>*]:flex  [&>*]:text-white">
            ...
            <div class="col-start-1 col-end-4 row-start-4 row-end-5 flex justify-between gap-2 [&>*]:rounded-lg ">
                ...
                <div class="bg-slate-800 w-full [&>*]:m-2 border-2 border-yellow-500">
                    ...
                    <div class="flex justify-around">
                    <p class="text-blue-500">{{$last_meal_nutrients['calories']}}kcal<br><span class="text-white">Calories</span></p>

                    <p class="text-red-500">{{$last_meal_nutrients['fat']}}g<br><span class="text-white">Fat</span></p>

                    <p class="text-orange-500">{{$last_meal_nutrients['carbohydrates']}}g<br><span class="text-white">Carbs</span></p>

                    <p class="text-green-500">{{$last_meal_nutrients['protein']}}g<br><span class="text-white">Protein</span></p>
                    </div>
                </div>
