...
@endphp
<div id="meal_item_{{ $foodIndex }}" class="min-h-[120px] active:bg-slate-950 border-none focus-within:outline-none focus-within:ring focus-within:ring-violet-300 bg-gray-800 w-64 rounded-lg p-6 text-white">
    <ul class="relative">
        ...
        <div class="select-none" id="food_wrapper_{{ $foodIndex }}">
            <li class="font-bold text-left">Number {{ $foodIndex }}</li>
        ...
        <div id="nutritional_wrapper_{{ $foodIndex }}" class="slide-down">
