<div id="food_number_{{$index}}" class="rounded-t-lg {{$active}} [&>div]:bg-white dark:[&>div]:bg-slate-800 dark:[&>*>*]:text-white [&>*>*>*]:text-black dark:[&>*>label>span]:text-white [&>*>*]:text-black [&>div>label>input]:bg-slate-300 dark:[&>div>label>input]:bg-slate-400 dark:[&>div>label>select]:text-black [&>div>label>select]:bg-slate-300 dark:[&>div>label>select]:bg-slate-400 w-full max-w-[90vw] h-max">
    ...
    <div class="md:grid md:grid-cols-2 gap-1 [&>*]:gap-4 [&>*]:items-center [&>*]:justify-between md:[&>*]:justify-start md:[&>*>input]:w-full [&>*>input]:w-[191px] [&>*>select]:w-[191px] md:[&>*>select]:w-full">
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            ...
            <input type="text" id="food_name_{{$index}}" name="food_name_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="Ricotta Cheese" value="{{$name}}" required/>
        </label>

        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Food Source</span>
            <input type="text" id="food_source_{{$index}}" name="food_source_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="Aldi" value="{{$source}}" required/>
        </label>

        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Serving Size</span>
            <input type="text" id="food_servingsize_{{$index}}" name="food_servingsize_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="100" value="{{$servingSize}}" required/>
        </label>
        ...
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6" for="food_servingunit_{{$index}}">
            ...
            <select type="text" id="food_servingunit_{{$index}}" name="food_servingunit_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="100" value="{{$servingUnit}}" autocomplete="off" required>
        ...
        {{-- <label class="hidden /md:block md:visible px-6 py-4 md:p-6 col-span-2" for="food_image_{{$index}}">
            ...
            <input type="file" name="food_image_{{$index}}" id="food_image_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md p-3"/>
    ...
    <div class="md:grid md:grid-cols-4 gap-1 [&>*]:gap-4 [&>*]:items-center [&>*]:justify-between [&>*>input]:w-[189px] md:[&>*>input]:w-full">
        ...
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            ...
            <input type="text" id="food_calories_{{$index}}" name="food_calories_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="182"  value="{{$calories}}" />
        </label>

        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Fat (g)</span>
            <input type="text" id="food_fat_{{$index}}" name="food_fat_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="14.1"  value="{{$fat}}" />
        ...
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            ...
            <input type="text" id="food_carbs_{{$index}}" name="food_carbs_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="4.7"  value="{{$carbs}}" />
        </label>

        
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Protein (g)</span>
            <input type="text" id="food_protein_{{$index}}" name="food_protein_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="11.7"  value="{{$protein}}" />
        </label>

         
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Sugars (g)</span>
            <input type="text" id="food_sugars_{{$index}}" name="food_sugars_{{$index}}" class="block bg-slate-800 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="4.7"  value="{{$sugars}}" />
        </label>

        
        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Saturates (g)</span>
            <input type="text" id="food_saturates_{{$index}}" name="food_saturates_{{$index}}" class="block bg-slate-800 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="8.1"  value="{{$saturates}}" />
        </label>

        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Fibre (g)</span>
            <input type="text" id="food_fibre_{{$index}}" name="food_fibre_{{$index}}" class="block bg-slate-800 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="0.4"  value="{{$fibre}}" />
        </label>

        <label class="flex whitespace-nowrap sm:block px-6 py-4 md:p-6">
            <span class="text-white">Salt (g)</span>
            <input type="text" id="food_salt_{{$index}}" name="food_salt_{{$index}}" class="block bg-slate-800 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="1.1"  value="{{$salt}}" />
    ...
    <div class="">
        <label class="block px-6 py-4 md:p-6">
            ...
            {{-- <input type="text" name="food_icon_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="" /> --}}
    ...
    <div class="">
        <label class="block px-6 py-4 md:p-6">
            ...
            <input type="text" id="food_description_{{$index}}" name="food_description_{{$index}}" class="block bg-slate-700 dark:text-black text-gray-200 w-full mt-1 rounded-md" placeholder="Tastes good on pizza" />
        </label>
    </div>
</div>
